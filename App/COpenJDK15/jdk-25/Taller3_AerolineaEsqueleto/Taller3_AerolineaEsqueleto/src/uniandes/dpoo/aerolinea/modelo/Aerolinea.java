...
private CalculadoraTarifas calculadoraTarifas;
    ...
    public void programarVuelo( String fecha, String codigoRuta, String nombreAvion ) throws Exception
    {
        ...
        for (Avion avion : aviones) {
            if (avion.getMatricula().equals(nombreAvion)) {
        ...
        if (avionSeleccionado == null) {
            throw new Exception("El avión con matrícula " + nombreAvion + " no existe.");
        }
        ...
        Vuelo nuevoVuelo = new Vuelo(fecha, ruta, avionSeleccionado);
    ...
    public int venderTiquetes( String identificadorCliente, String fecha, String codigoRuta, int cantidad ) throws VueloSobrevendidoException, Exception
    {
        ...
        int tarifaBase = vuelo.getTarifaBase();
        int tarifaFinal = calculadoraTarifas.calcularTarifa(cliente, tarifaBase);

        return tarifaFinal * cantidad;
    }
    ...
    public String consultarSaldoPendienteCliente( String identificadorCliente )
    {
        ...
        return "Saldo pendiente del cliente " + identificadorCliente + ": " + saldo;
    }
    
    public void agregarVuelo(Vuelo vuelo) {
        this.vuelos.add(vuelo);
    }
    public void setCalculadoraTarifas(CalculadoraTarifas calculadora) {
        this.calculadoraTarifas = calculadora;
    }

    public CalculadoraTarifas getCalculadoraTarifas() {
        return this.calculadoraTarifas;
    }
